...
We have a more complete guide on how to use ObjectCache in Android, check out: [README-ANDROID.md][https://github.com/progund/object-cache/blob/master/doc/README-ANDROID.md]
